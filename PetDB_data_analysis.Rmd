...
The dois of PetDB records were retrieved by data mining and are stored in the file "specimen_locations_new.csv".

These dois are then used (in Sections 1 and 2) to manually search the Web of Science database to retrievev author address data for ~1500 publications.
...
refs<-read.csv("PetDB_specimen_locations.csv", encoding = "UTF-8")
...
if(!file.exists("search_string.txt")){
  write.table(string, "search_string.txt", row.names = F)
}
